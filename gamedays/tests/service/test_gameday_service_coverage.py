...
class TestGamedayServiceCoverage:
    ...
    def test_empty_gameday_service_methods(self):
        ...
        assert EmptyGamedayService.get_resolved_designer_data(99999) == {"nodes": [], "edges": []}
    ...
    def test_resolve_team_edge_cases(self):
        ...
        data = {
            "nodes": [{
                "type": "game",
                "data": {
                    "homeTeamDynamic": {"matchName": "G1", "type": "winner"}
                }
            }]
        }
        ...
        gameday.designer_data = {
            "nodes": [{
                "type": "game",
                "data": {
                    "awayTeamDynamic": {"matchName": "G1", "type": "loser"}
                }
            }]
        }
        gameday.save()
    ...
    def test_gameday_game_service_format_helpers(self):
        ...
        assert GamedayGameService._format_event_with_player(row) == "<s>1-Extra-Punkt</s>"
