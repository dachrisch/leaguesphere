...
function useFlowStateInternal(initialState?: Partial<FlowState>, onStateChange?: () => void) {
  ...
  return useMemo(() => ({
    ...
    addGlobalTeamsBulk: teamPoolManager.addGlobalTeamsBulk,
    updateGlobalTeam: teamPoolManager.updateGlobalTeam,    deleteGlobalTeam: teamPoolManager.deleteGlobalTeam,
